/* =====================================================================
   Widget de acessibilidade — CÓPIA do site principal (js/main.js).

   Está aqui, e não no main.js compartilhado, porque o main.js traz junto o
   carrossel e o modal de comunicado da clínica — que não fazem sentido nesta
   área e apareceriam por cima do curso.

   SE MEXER NO ORIGINAL, MEXA AQUI TAMBÉM. Os dois têm de dizer a mesma
   coisa: é a mesma ferramenta, para a mesma pessoa.
   ===================================================================== */
